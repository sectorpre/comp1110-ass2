...
public class CheckEndTest {
    ...
    public void applyAllResourcesCollected(String gameString,boolean expected){
        Model test = new Model();
        test.toModel(gameString);
        boolean actual = test.board.allResourcesCollected();
        Assertions.assertEquals(expected,actual);
    }

    //test the AllResourcesCollected method
    //check if all the resources are collected or not

    @Test
    public void testAllResourceCollected(){
        //true case
        applyAllResourcesCollected(DEFAULT_GAME,true);
        applyAllResourcesCollected(WHEELS_GAME,true);
        applyAllResourcesCollected(FACE_GAME,true);
        applyAllResourcesCollected(SIDES_GAME,true);
        applyAllResourcesCollected(SPACE_INVADERS_GAME,true);
        applyAllResourcesCollected(SETTLE_SIDES_GAME,true);

        //false case
        applyAllResourcesCollected(NORMAL_GAME,false);
        applyAllResourcesCollected(SETTLE_GAME,false);
        applyAllResourcesCollected(MOVES_END_GAME,false);
    }


    //check if a player has valid moves or not
    public void applyNoValidMoves(String gameState,boolean expected){
        Model test = new Model();
    ...
    public void testNoValidMoves(){
        //players still have valid moves
        applyNoValidMoves(DEFAULT_GAME,false);
        applyNoValidMoves(WHEELS_GAME,false);
        applyNoValidMoves(FACE_GAME,false);
        applyNoValidMoves(SIDES_GAME,false);
        applyNoValidMoves(SPACE_INVADERS_GAME,false);
        applyNoValidMoves(NORMAL_GAME,false);
        applyNoValidMoves(SETTLE_GAME,false);
        applyNoValidMoves(SETTLE_SIDES_GAME,false);
        //players have no valid moves
        applyNoValidMoves(MOVES_END_GAME,true);
    }

    public void applyCheckEnd(String gameState,Boolean expected){
        Model test = new Model();
        test.toModel(gameState);
        boolean actual = test.checkEnd();
        Assertions.assertEquals(expected,actual);
    }

    @Test
    public void testCheckEnd(){
        //DEFAULT_GAME: all resources collected, still have valid moves
        applyCheckEnd(DEFAULT_GAME,true);
        //WHEELS_GAME: all resources collected, still have valid moves
        applyCheckEnd(WHEELS_GAME,true);
        //FACE_GAME: all resources collected, still have valid moves
        applyCheckEnd(FACE_GAME,true);
        //SIDES_GAME: all resources collected, still have valid moves
        applyCheckEnd(SIDES_GAME,true);
        //SPACE_INVADERS_GAME: all resources collected, still have valid moves
        applyCheckEnd(SPACE_INVADERS_GAME,true);
        //SETTLE_SIDES_GAME: all resources collected, still have valid moves
        applyCheckEnd(SETTLE_SIDES_GAME,true);
        //NORMAL_GAME: all resources not collected, still have valid moves
        applyCheckEnd(NORMAL_GAME,false);
        //SETTLE_GAME: all resources not collected, still have valid moves
        applyCheckEnd(SETTLE_GAME,false);
        //SETTLE_SIDES_GAME: all resources collected, still have valid moves
        applyCheckEnd(SETTLE_SIDES_GAME,true);
        //MOVES_END_GAME: all resources not collected, no valid moves
        applyCheckEnd(MOVES_END_GAME,true);
    }
